...
Kartus  kartusOlustur(lv_obj_t* parent, lv_coord_t  x, lv_coord_t y) {
    ...
    lv_img_set_src(img1, &kartus_normal);
...
Kartus kartus_Create(lv_obj_t* parent, lv_coord_t  x, lv_coord_t y) {
    ...
    return kartusOlustur(parent,x, y);
}
