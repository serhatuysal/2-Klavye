...
Dirsek6  dirsek6Olustur(lv_obj_t* parent, lv_coord_t  x, lv_coord_t y, int16_t angle) {
    ...
    lv_obj_set_style_transform_pivot_x(main, 7, 0);
    lv_obj_set_style_transform_pivot_y(main, 7, 0);
...
Dirsek6 dirsek6_Create(lv_obj_t* parent, lv_coord_t  x, lv_coord_t y, int16_t angle) {
    ...
    return dirsek6Olustur(parent,x, y,angle);
}
